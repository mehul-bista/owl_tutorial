...
export class ExternalLibraries extends Component {
    setup(){
        ...
        onWillStart(async ()=>{
            ...
            await loadJS("/owl_demo/static/src/lib/intl-tel-input/build/js/intlTelInput.min.js")
            await loadCSS("/owl_demo/static/src/lib/intl-tel-input/build/css/intlTelInput.css")
